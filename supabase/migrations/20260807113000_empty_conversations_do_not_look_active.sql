-- Empty conversations created from "contact seller" should stay visually idle
-- until a real message exists. This avoids phantom unread states and fake
-- "new message" ordering for threads with no actual content yet.
